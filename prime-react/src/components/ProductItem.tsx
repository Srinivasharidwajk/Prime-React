...
import {
    Grid, Card, CardContent, Typography, Button, Table,
    TableHead, TableBody, TableRow, TableContainer, TableCell, makeStyles, withStyles
                ...
                <Grid item xs={10}>
                    <TableContainer>
                        <Table className={classes.table}>
                            <TableHead >
                                <TableRow>
                                    <TableCell className={classes.tableHead}>SNO</TableCell>
                            ...
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell>
                                        <Icon onClick={decrQty} fontSize="small" style={{color : 'teal'}}>remove_circle</Icon>
                                        <sup>{product.qty}</sup>
                                        <Icon onClick={incrQty} fontSize="small" style={{color : 'teal'}}>add_circle</Icon>
                                    </TableCell>
